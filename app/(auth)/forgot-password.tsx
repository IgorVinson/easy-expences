...
export default function ForgotPasswordScreen() {
  ...
  const iconSize = isCompact ? 72 : 96;
  const iconGlyphSize = isCompact ? 36 : 48;
               ...
               <View className="flex-1 items-center justify-center">
                 <View
                   ...
                   style={{
                    ...
                    <Ionicons name="mail-open" size={iconGlyphSize} color="#10B981" />
                 </View>
                 <Text className="mb-2 text-center text-2xl font-bold" style={{ color: theme.textPrimary }}>{t('auth.checkEmail')}</Text>
                 <Text
                   className="text-center text-base"
                   style={{ color: theme.textSecondary, marginBottom: isCompact ? 14 : 20 }}>
                   {t('auth.resetEmailSent')}
                 </Text>
                 <Text
                   className="text-center text-sm"
                   style={{ color: theme.textSecondary, marginBottom: isCompact ? 18 : 28 }}>
